...
- **ci-drilldown-report skill** — wraps `ci-effective-report/gh_ci_report.py` for agent invocation; the forensics timing-cause analysis (ADR-010 successor) is merged into the drilldown HTML with 0 extra API calls.
